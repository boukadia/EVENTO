	...
	<div class="topbar d-flex align-items-center">
		<nav class="gap-3 navbar navbar-expand">
			...
			<div class="flex-grow-1 search-bar">
				<div class="position-relative search-bar-box">
					<input type="text" class="form-control search-control" placeholder="Type to search..."> <span
						class="top-50 position-absolute search-show translate-middle-y"><i
							class='bx bx-search'></i></span>
					<span class="top-50 position-absolute search-close translate-middle-y"><i
							class='bx bx-x'></i></span>
				</div>
			</div>
			<div class="top-menu ms-auto">
				<ul class="align-items-center gap-1 navbar-nav">
					<li class="d-flex mobile-search-icon d-lg-none nav-item" data-bs-toggle="modal"
					...
					<li class="dropdown dropdown-large">
						<a class="position-relative dropdown-toggle dropdown-toggle-nocaret nav-link" href="#"
							data-bs-toggle="dropdown"><span class="alert-count" id="notif-count">7</span>
			...
			<div class="px-3 dropdown user-box">
				<a class="d-flex align-items-center gap-3 dropdown-toggle dropdown-toggle-nocaret" role="button"
				...
				<ul class="dropdown-menu dropdown-menu-end">
					<li><a class="d-flex align-items-center dropdown-item" href="javascript:;"><i
					...
					<li><a class="d-flex align-items-center dropdown-item" href="/logout"><i
